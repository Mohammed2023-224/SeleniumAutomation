...
public class ElementActions {
    ...
    public static Boolean checkIfElementExists(WebDriver driver, By locator) {
        ...
        try {
            if (!driver.findElements(locator).isEmpty()) {
                flag = true;
             Loggers.logInfo("Element located at "+locator+" exists");
            }
        } catch (Exception e) {
         Loggers.logWarn("Element located at "+locator+" doesn't exist");
        }
        return flag;
    }
    ...
    public static Boolean checkIfElementVisible(WebDriver driver, By locator) {
        ...
        try {
         ...
         Loggers.logWarn("Element located at "+locator+" isn't visible");
        }
        return flag;
    }
    ...
    public static Boolean checkIfElementClickable(WebDriver driver, By locator) {
        ...
        try {
         ...
         Loggers.logWarn("Element located at "+locator+" isn't clickable");
        }
        return flag;
    }
    ...
    public static Boolean checkIfElementSelected(WebDriver driver, By locator) {
        ...
        try {
            if (driver.findElement(locator).isSelected()) {
                flag = true;
             Loggers.logInfo("Element located at "+locator+" is selected");
            }
        } catch (Exception e) {
         Loggers.logWarn("Element located at "+locator+" isn't selected");
        }
        return flag;
    }
}